		...
		public class TableStorage : IDisposable {
			...
			void Init() {
				...
				_blockSmoothingGroups = new uint[(int)EVoxelBlockType.NumBlockTypes - 1] {
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_DIRT -> blends with rock and grass
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_GRASS
					BLOCK_SMG_WATER | BLOCK_BLEND_COLORS, // BLOCK_TYPE_WATER
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_SAND
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_SNOW
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_ROCK
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_ICE
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_WOOD
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_LEAVES
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_NEEDLES
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_FLOWERS1
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_FLOWERS2
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS, // BLOCK_TYPE_FLOWERS3
					BLOCK_SMG_DIRT_ROCK | BLOCK_SMG_GRASS | BLOCK_BLEND_COLORS// BLOCK_TYPE_FLOWERS4
				};
